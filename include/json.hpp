...
#ifdef NOA_JSON_DYNAMIC
	#if defined(_WIN32) && !defined(__CYGWIN__)
		#ifdef NOA_JSON_EXPORTING
			#define NOA_JSON_DLL __declspec(dllexport)
		#else
			#define NOA_JSON_DLL __declspec(dllimport)
		#endif
	#else
		#ifdef NOA_JSON_EXPORTING
			#define NOA_JSON_DLL [[gnu::visibility("default")]]
		#else
			#define NOA_JSON_DLL
		#endif
	#endif
...
namespace json {
	...
	class NOA_JSON_DLL Value final {
	...
	class NOA_JSON_DLL Object final {
